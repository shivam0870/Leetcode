...
<pre style="position: relative;"><strong>Input:</strong> nums = [-2,-1,-1,1,2,3]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [-3,-2,-1,0,0,1,2]
<strong>Output:</strong> 3
...
<pre style="position: relative;"><strong>Input:</strong> nums = [5,20,66,1314]
